...
export default function Sidebar() {
	return (
		<div className="fixed top-0 bottom-0 lg:left-0 p-2 w-[250px] overflow-y-auto text-center shadow bg-white text-gray-500 ">
			{/* Logo Sijafung BPS */}
			<Link href="/">
			...
			<div className="mt-8 gap-y-2 flex flex-col">
				...
				<Link href="/forum">
					<div className="p-2.5 flex items-center rounded px-4 duration-300 cursor-pointer hover:bg-gray-200 ">
						<Image
							src={"/logoMenu/logoForum.svg"}
							width={25}
							height={25}
							alt={"logoBeranda.png"}
						/>
						<span className="text-[15px] ml-3 ">Forum Diskusi</span>
					</div>
				</Link>
				{/* Peraturan */}
				<Link href="/peraturan">
