...
export default function TopNav() {
	return (
		<div className="md:flex hidden justify-between items-center my-2 mb-8 z-50">
			{/* Searchbar */}
			<div className="">
				<div className="relative flex items-center w-[800px]  h-11 rounded-full focus-within:shadow-lg bg-white overflow-hidden">
			...
			<div className="flex gap-x-4 items-center justify-center">
				...
				{/* <Menu as="div" className="relative inline-block text-left">
					...
					>
						<Menu.Items className="absolute overflow-y-scroll z-50 max-h-[400px] right-0 mt-2 min-w-[450px] origin-top-right divide-y divide-gray-100 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
							<div>
								...
								<Menu.Item className="p-4 border">
									{({ active }) => (
										<button
											className={`${
