	...
	return (
		<nav className="md:hidden shadow-md flex flex-wrap items-center justify-between w-full py-4 md:py-0 px-8 text-lg text-gray-700 bg-white">
			...
			<div
				...
				id="menu"
			>
				<ul className="pt-4 text-base text-gray-700md:flex md:justify-between md:pt-0">
					<li>
					...
					<Disclosure className="flex gap-0">
						{({ open }) => (
							<>
								<Disclosure.Button className="md:p-4 py-2 hover:text-purple-400 flex items-center">
									Registrasi Akun
									<ChevronRightIcon
										className={`${
								...
								<Disclosure.Panel>
									<Link
										className="p-2.5 flex items-center rounded px-2 duration-300 hover:text-purple-400  cursor-pointer mr-4"
